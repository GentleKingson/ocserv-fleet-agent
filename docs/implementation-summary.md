...
| 8a. Scheduler reliability | Implemented A3 reliability slices | Schemas 19-20 add deterministic fenced claims, lease heartbeat, abandoned-run recovery, bounded misfire coalescing, transient-only retry/backoff under a hard RPC budget, and atomically audited global maintenance suppression. Final shutdown/restart acceptance remains active A3 work. |
