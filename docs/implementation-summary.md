...
| 8a. Scheduler reliability | Implemented A3 claim/fence slice | Schema 19 adds immediate deterministic due-job claims, monotonic fences, active-run binding, lease expiry, and atomic abandoned-run recovery. Production run-once and daemon paths use the claim boundary. Renewal, retry/misfire/maintenance, and final shutdown/restart acceptance remain active A3 work. |
